...
Dependencies:
    ...
    - verified_sources.common.doc_splitters.Document: A document class from the verified_sources.common.doc_splitters module.
...
from verified_sources.common.doc_splitters import Document
